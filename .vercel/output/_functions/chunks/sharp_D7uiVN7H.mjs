import { A as AstroError, aG as MissingSharp } from './transition_aFiTmAOW.mjs';
import { b as baseService, p as parseQuality } from './generic_Bq1mo4Y1.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_DsNWbEwq.mjs').then(n => n.i)).default;
  } catch {
