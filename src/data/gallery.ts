...
export const galleryItems: GalleryItem[] = [
  ...
  },
  {
    ...
    artist: "Vanya",
    date: "Mars 2026",
    description: "Un portrait plus nocturne de Fortune, construit autour d'une posture calme et d'une tension tres contenue.",
  },
  {
    id: "gal-17",
    title: "Renard",
    ...
    artist: "Vanya",
    date: "Mars 2026",
    description: "Une interpretation plus brute de Renard, pensee comme une image de confrontation avec sa part la plus sombre.",
  },
  {
    id: "gal-18",
    title: "Notre sang danas l'humus de la Forêt",
    image: "/assets/gallery/notre-sang-dans-lhumus-de-la-foret--scene.webp",
    alt: "Illustration Notre sang danas l'humus de la Forêt",
    bookKey: "notre-sang-dans-lhumus-de-la-foret",
    book: "Notre sang danas l'humus de la Forêt",
    artist: "Vanya",
    date: "Mars 2026",
    description: "Une scene plus allegorique, tiree vers le conte sombre et la rencontre avec une presence presque rituelle.",
  },
  {
    id: "gal-19",
    ...
    bookKey: "trouver-la-lune",
    book: "Trouver la lune",
    artist: "Vanya",
    date: "Mars 2026",
    description: "Un portrait de dos articule autour des croissants de lune, avec une lecture plus symbolique et hivernale.",
  },
  {
    id: "gal-20",
    title: "Trouver la lune",
    ...
    artist: "Vanya",
    date: "Mars 2026",
    description: "Une variation plus contemplative de Trouver la lune, portee par un cadre froid et un portrait resserre.",
  },
];
